...
@section('content')
    <div class="row">
        ...
        <div class="col-12 rounded border m-2">
            <h4 class="m-3">Continuance Feri Application Form</h4>
        </div>
        <div class="col-12">
                        ...
                        <div class="col-12 tab-content">
                            ...
                            <div class="tab-pane fade show active mt-4 p-3" id="t1" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <div class="input-group input-group-static mb-4">
                                            <label>Validated Feri Certificate Number</label>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <div class="input-group input-group-static">
                                            <label for="exampleFormControlSelect2" class="ms-0">DRC Border</label>
                                    ...
                                    <div class="col-12 col-lg-4 mb-3">
                                        <div class="input-group input-group-static">
                                            <label for="exampleFormControlSelect2" class="ms-0">Final Destination</label>
                            ...
                            <div class="tab-pane fade mt-4 p-3" id="t2" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-12 mb-3">
                                        <div class="input-group input-group-static">
                                            <label for="exampleFormControlSelect2" class="ms-0">Transporter
                                                Company</label>
                                    ...
                                    <div class="col-12 col-lg-6 mb-3">
                                        <div class="input-group input-group-static">
                                            <label for="exampleFormControlSelect2" class="ms-0">Shipping Agent</label>
                                            <select class="form-control" name="cf_agent">
                                                ...
                                                <option value="DOUANE EXPRESS CUSTOMS"
                                                    {{ old('cf_agent') == 'DOUANE EXPRESS CUSTOMS' ? 'selected' : '' }}>
                            ...
                            <div class="tab-pane fade mt-4 p-3" id="t3" role="tabpanel">
                                <div class="row">
                                    ...
                                    <div class="col-12 col-lg-3 mb-3">
                                        <div class="input-group input-group-static">
                                            <label for="exampleFormControlSelect2" class="ms-0">Freight Currency</label>
                                            <select class="form-control" name="freight_currency">
                                                <option value="USD"
                                                    {{ old('freight_currency') == 'USD' ? 'selected' : '' }}>USD
                                                </option>
                                                <option value="EUR"
                                                    {{ old('freight_currency') == 'EUR' ? 'selected' : '' }}>EUR
                                                </option>
                                                <option value="ZAR"
                                                    {{ old('freight_currency') == 'ZAR' ? 'selected' : '' }}>ZAR
                                                </option>
                                                <option value="EUR"
                                                    {{ old('freight_currency') == 'EUR' ? 'selected' : '' }}>EUR
                                                </option>
                                                <option value="AOA"
                                                    {{ old('freight_currency') == 'AOA' ? 'selected' : '' }}>AOA
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-12 col-lg-3 mb-3">
                                        <div class="input-group input-group-static mb-4">
                                            <label>Customs Docs <span class="fs-6 text-danger">*</span>
                                            </label>

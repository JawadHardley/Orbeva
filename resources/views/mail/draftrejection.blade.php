...
<body>
    <div class="email-wrapper">
        ...
        <div class="content">
            ...
            Applicant feedback indicates that the draft certificate for the application below was not approved. Review
            the rejection reason and update the certificate accordingly prior to resubmission.
            <br><br>
            - Application Info<br>

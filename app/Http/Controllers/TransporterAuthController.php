...
class TransporterAuthController extends Controller
{
    ...
    public function downloadFeriExcelTemplate()
    {
        ...
        $finalDestinations = ['Likasi DRC', 'Lubumbashi DRC', 'Kolwezi DRC', 'Tenke DRC', 'Kisanfu DRC', 'Lualaba DRC', 'Pumpi DRC', 'Kambove DRC'];
        $cfAgents = ['AGL', 'CARGO CONGO', 'CONNEX', 'African Logistics', 'OLA', 'Afritac', 'Amicongo', 'Aristote', 'Bollore', 'Brasimba', 'Brasimba S.A', 'Chemaf', 'Comexas Afrique', 'Comexas', 'DCG', 'DOUANE EXPRESS CUSTOMS', 'Evele & Co', 'Gecotrans', 'Global Logistics', 'Malabar', 'Polytra', 'Spedag', 'Tradecorp', 'Trade Service'];

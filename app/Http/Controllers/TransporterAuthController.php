...
class TransporterAuthController extends Controller
{
    ...
    public function downloadFeriExcelTemplate()
    {
        ...
        $cfAgents = ['AGL', 'CARGO CONGO', 'CONNEX', 'African Logistics', 'OLA', 'Afritac', 'Amicongo', 'Aristote', 'Bollore', 'Brasimba', 'Brasimba S.A', 'Chemaf', 'Comexas Afrique', 'Comexas', 'DCG', 'Evele & Co', 'Gecotrans', 'Global Logistics', 'Malabar', 'Polytra', 'Spedag', 'Tradecorp', 'Trade Service'];
